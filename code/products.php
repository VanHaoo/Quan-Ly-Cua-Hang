...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'create') {
            ...
            $stmt = $pdo->prepare('UPDATE products SET code=?,name=?,category=?,price=?,stock=?,min_stock=?,unit=? WHERE id=?');
...
<div class="two-column">
    <section class="panel form-panel">
        <div class="panel-heading"><div><h2><?= $edit ? 'Cập nhật sản phẩm' : 'Thêm sản phẩm' ?></h2><p>Nhập thông tin hàng hóa và mức cảnh báo</p></div></div>
        <form method="post" class="form-grid">
            ...
            <label>Giá bán<input type="number" name="price" min="1" step="1000" value="<?= e($edit['price'] ?? '') ?>" required></label>
    ...
    <section class="panel">
        ...
        <div class="table-wrap"><table>
            <thead><tr><th>Mã</th><th>Sản phẩm</th><th>Giá</th><th>Tồn</th><th>Trạng thái</th><th>Thao tác</th></tr></thead>
            <tbody>
